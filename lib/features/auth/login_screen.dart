...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handleSendOtp() async {
    ...
    if (mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('OTP sent to your mobile number (Simulated OTP: 123456) 📩'),
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.person_rounded, color: AppColors.primarySaffron),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading
                            ...
                            : Text(
                                _isOtpSent ? 'Verify & Login 🚩' : 'Get OTP & Login',
              ...
              OutlinedButton.icon(
                ...
                label: const Text(
                  'Quick Devotee Login (Demo Session)',
                  style: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.bold,
